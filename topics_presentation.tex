...
If the machine {\em accepted}, then the output of it is the contents of the tape.

If the machine {\em rejected}, then nothing is returned.
\end{frame}
...
Cook showed that any $NTM\, M$ can be converted to a boolean formula such that:
