...
\date{$15$th December, $2015$} % Date, can be changed to a custom date
...
$q = q_0$\\
$h = 0$\\
$T = w||\sqcup^n$ \tcp*{Tape starts as just input, followed by blank cells}
...
\begin{center}
\begin{tikzpicture}[node distance=3cm,on grid,auto]
    \node[state] (q0) at (0,0) {$\mathbf{q_0}$};
    \node[state] (q1) [right of=q0] {$q_1$};
    \node[accepting,state] (qaccept) [right of=q1] {$q_{accept}$};
    \node[state] (qreject) [below of=q1] {$q_{reject}$};
    \path[->]
...
%% Draw TM tape
\begin{scope}[shift={(8cm,0cm)},start chain=1 going right,node distance=0.7cm]
    \node [on chain=1,tmtape] {$\mathbf{0}$};
...
\begin{tikzpicture}[node distance=3cm,on grid,auto]
    ...
    \node[state] (qreject) [below of=q1] {$q_{reject}$};
    \path[->]
        (q0) edge node {$\mathbf{0 \to (0, R)}$} (q1)
        (q1) edge node {$1 \to (0, R)$} (qaccept)
        (q0) edge node[sloped, anchor=south] {$1 \to (1, R)$} (qreject)
        (q0) edge[bend right, sloped, anchor=north] node {$\sqcup \to (\sqcup, R)$} (qreject)
        (q1) edge node[sloped, anchor=north] {$0 \to (1, R)$} (qreject)
...
\begin{tikzpicture}[node distance=3cm,on grid,auto]
    \node[state] (q0) at (0,0) {$q_0$};
    \node[state] (q1) [right of=q0] {$\mathbf{q_1}$};
    \node[accepting,state] (qaccept) [right of=q1] {$q_{accept}$};
    \node[state] (qreject) [below of=q1] {$q_{reject}$};
    \path[->]
        (q0) edge node {$0 \to (0, R)$} (q1)
...
\begin{scope}[shift={(8cm,0cm)},start chain=1 going right,node distance=0.7cm]
    ...
    \node [on chain=1,tmtape] {$\mathbf{1}$};
    \node [on chain=1,tmtape] {$\sqcup$};
\end{scope}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[node distance=3cm,on grid,auto]
    ...
    \path[->]
        (q0) edge node {$0 \to (0, R)$} (q1)
        (q1) edge node {$\mathbf{1 \to (0, R)}$} (qaccept)
        (q0) edge node[sloped, anchor=south] {$1 \to (1, R)$} (qreject)
        (q0) edge[bend right, sloped, anchor=north] node {$\sqcup \to (\sqcup, R)$} (qreject)
        (q1) edge node[sloped, anchor=north] {$0 \to (1, R)$} (qreject)
        (q1) edge[bend left, sloped, anchor=south] node {$\sqcup \to (\sqcup, R)$} (qreject);
...
\begin{tikzpicture}[node distance=3cm,on grid,auto]
    \node[state] (q0) at (0,0) {$q_0$};
    \node[state] (q1) [right of=q0] {$q_1$};
    \node[accepting,state] (qaccept) [right of=q1] {$\mathbf{q_{accept}}$};
    \node[state] (qreject) [below of=q1] {$q_{reject}$};
    \path[->]
        (q0) edge node {$0 \to (0, R)$} (q1)
        (q1) edge node {$1 \to (0, R)$} (qaccept)
...
\begin{scope}[shift={(8cm,0cm)},start chain=1 going right,node distance=0.7cm]
    \node [on chain=1,tmtape] {$0$};
    \node [on chain=1,tmtape] {$0$};
    \node [on chain=1,tmtape] {$\mathbf{\sqcup}$};
\end{scope}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[node distance=3cm,on grid,auto]
    ...
    \path[->]
        ...
        (q0) edge node[sloped, anchor=south] {$1 \to (1, R)$} (qreject)
        (q0) edge[bend right, sloped, anchor=north] node {$\sqcup \to (\sqcup, R)$} (qreject)
        (q1) edge node[sloped, anchor=north] {$\mathbf{1 \to (1, R)}$} (qreject)
        (q1) edge[bend left, sloped, anchor=south] node {$\sqcup \to (\sqcup, R)$} (qreject);
...
\begin{tikzpicture}[node distance=3cm,on grid,auto]
    ...
    \node[state] (q1) [right of=q0] {$q_1$};
    \node[accepting,state] (qaccept) [right of=q1] {$q_{accept}$};
    \node[state] (qreject) [below of=q1] {$\mathbf{q_{reject}}$};
    \path[->]
        (q0) edge node {$0 \to (0, R)$} (q1)
        (q1) edge node {$0 \to (0, R)$} (qaccept)
        (q0) edge node[sloped, anchor=south] {$1 \to (1, R)$} (qreject)
...
\begin{tikzpicture}[node distance=3cm,on grid,auto]
    ...
    \node[state] (qreject) [below of=q1] {$q_{reject}$};
    \path[->]
        (q0) edge[anchor=north] node {$\mathbf{0 \to (0, R)}$} (q1)
        (q1) edge node {$0 \to (0, R)$} (qaccept)
        (q0) edge node[sloped, anchor=south] {$1 \to (1, R)$} (qreject)
        (q0) edge[bend right, sloped, anchor=north] node {$\sqcup \to (\sqcup, R)$} (qreject)
        (q1) edge[bend right, anchor=south] node {$1 \to (1, L)$} (q0)
...
\begin{tikzpicture}[node distance=3cm,on grid,auto]
    ...
    \path[->]
        ...
        (q0) edge node[sloped, anchor=south] {$1 \to (1, R)$} (qreject)
        (q0) edge[bend right, sloped, anchor=north] node {$\sqcup \to (\sqcup, R)$} (qreject)
        (q1) edge[bend right, anchor=south] node {$\mathbf{1 \to (1, L)}$} (q0)
        (q1) edge[sloped, anchor=south] node {$\sqcup \to (\sqcup, R)$} (qreject);
...
\begin{center}
\begin{tikzpicture}[node distance=3cm,on grid,auto]
    \node[state] (qreject) at (0,0) {$q_{reject}$};
    \node[state] (q0) [right of=qreject] {$q_0$};
    \node[accepting,state] (qaccept) [right of=q0] {$q_{accept}$};
    \path[->]
        (q0) edge [anchor=south] node {$0 \to (0, R)$} (qreject)
        (q0) edge [loop above] node {$\sqcup \to (0, R)$} (q0)
        (q0) edge node {$1 \to (1, R)$} (qaccept);
\end{tikzpicture}
\end{center}
...
$H'$ is described as follows:
\begin{algorithm}[H]
\eIf{$H$ accepts $(H', H')$}{go into an infinite loop \tcp*{Doesn't halt even though $H$ says we should halt}}
{accept \tcp*{Halts even though $H$ says we shouldn't halt}}
\end{algorithm}
